...
\textbf{Netskope}
\hfill
%% \DatestampY{2023} -- Present
\DatestampYM{2023}{08} -- Present

Staff Site Reliability Engineer

\begin{Detail}
Member of team supporting Netskope's data-loss prevention product undergoing a transition to a multi-tenant solution with a Kubernetes-based architecture. 

\BulletItem
My primary role is driving operational efficiencies and team productivity by implementing automation tooling and improving team workflows, guiding and balancing long-term improvements with tactical improvements.

\BulletItem
I partner with Infrastructure and Development teams to keep focus on reliability and supportability goals for the new system.


%%\BulletItem
%%Focus on features to improve reliability and supportability when working with Infrastructure, Development and Product teams to deliver reliable, robust, and supportable applications.

%%\BulletItem
%%Understand better the features and challenges of the existing and new system by participating in the support oncall rotation.
