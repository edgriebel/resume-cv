...
Excitement about creating code to deilver high quality useful software results in systems that support business growth.
\iffalse
\Entry
...
\DatestampY{2005} -- \Datestamp{2010}
...
\begin{Detail}
\Item
Created Java applications to build DSL circuits and track call center commissions; CruiseControl used for Continuous Integration. 
Automated generation of 20 Excel spreadsheets from Hyperion EssBase saving two FTEs weekly.
...
\begin{Detail}
\Item
Created trading systems in C/C++ and tactical applications for equity derivatives trading desk.
