...
\begin{Detail}
\BulletItem
Work closely with peer developers, product owners, and operations teams to create a new credit product including processing, accounting, statementing, and user-level APIs.
\BulletItem
...
\hfill
Occasionally since \DatestampYM{2020}{01}
...
\begin{Detail}
\BulletItem
Determine performance issues impacting system scalability and work with technical owners for prioritization and resolution
\BulletItem
...
\BulletItem
Mentor and guide junior developers in Catalant's development environment and software engineering practices


\Gap
Technologies: Python, Flask, JavaScript, MySQL, Bootstrap, Docker, Elasticsearch
...
\BulletItem
Created custom Chaos Monkey implementation to randomly kill middleware appliances and Java processes daily in production and non-production environments. The Chaos Monkey was monitored and controlled by a Spring Boot web application and Splunk dashboard.
...
\Gap
Technologies: Java, JavaScript, JQuery-UI, Oracle PL/SQL, Scikit-Learn, Python, AppDynamics, Application Performance Monitoring (APM), ClearCase, Ant, Git, JUnit, Vagrant
\end{Detail}
...
\begin{Detail}
\BulletItem
Fullstack Java/Oracle/ActiveMQ JMS developer for IoT system. Lead the integration and upgrade of Cognos Business Intelligence with IoT system using Groovy and Java.
\BulletItem
Internal technical consulting with professional services and product management teams.
...
\begin{Detail}
\BulletItem
Lead team of five to create Java/JavaScript front end and webapp for an existing internal fat client, and upgrade two existing web applications to contemporary standards. Used Hudson to create a CI/CD pipeline to QA environment.

\BulletItem
Mentored new developers, delivered technical training, and internal technical consulting.
%% 2021-05-02 TMI
\iffalse
\BulletItem
...
\begin{Detail}
\BulletItem
Lead for team of five to create Java/JavaScript front end and webapp for an existing internal fat client, and upgrade two existing web applications to contemporary standards. Used Hudson to create a CI/CD pipeline to QA environment.  Mentored new developers, delivered technical training and technical consulting.
\end{Detail}
