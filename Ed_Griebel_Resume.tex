...
\Gap
\BulletItem
Led team with cross-functional partners to create REST interfaces to legacy payroll system, leading to 45\% of emailed payrolls being processed by an AI service agent.
...
\BulletItem
Improved team productivity during rapid organizational and Agile SDLC changes by mentoring permanent, intern, and offshore teammates and encouraging a positive, proactive ownership mindset.
\end{Detail}

%% \Gap Technologies: Python \techsep Java \techsep GitHub Copilot \techsep Oracle SQL \techsep Splunk

\tech{Python \techsep Java \techsep GitHub Copilot+Claude \techsep Oracle SQL \techsep Splunk}
