...
\Gap
\BulletItem
Led team to create, with cross-functional partners, REST interfaces to legacy system for an AI service agent. 
...
\BulletItem
Improved team productivity during rapid organizational and Agile SDLC changes by mentoring intern, permanent, and offshore teammates on having a positive and proactive ownership mindset.
\end{Detail}
...
Engineered global-scale infrastructure for automated server provisioning and optimized dynamic capacity allocation for Facebook and Instagram ad-serving ML models.

\BulletItem
Automated firmware updates for multiple hardware vendors across 10,000+ physical servers. Eliminating ad-hoc
updates across 25 clusters \comment{saved nearly a week of effort} saved three days of effort every quarter for each cluster.
...
\BulletItem
Supported and enhanced systems to provision bare metal and virtual servers using Python, Terraform, and Chef.
