...
Led a team of Site Reliability Engineers to support Netskope's data-loss prevention product by aligning deliverables with partner roadmaps, including hands-on engineering and participating in on call rotations.
...
\BulletItem
	Supported and enhanced systems to create/update bare metal and virtual servers using Python, VMWare and Chef.
\BulletItem
