...
\Gap
\begin{Detail}
Technical lead for development teams, focusing on Artificial Intelligence initiatives.
\end{Detail}

%% \tech{Python $|$ Azure Cloud $|$ Grafana $|$ Prometheus $|$ Spinnaker $|$ Jenkins}
...
\BulletItem
Partnered with development team to migrate Kubernetes deployments (private cloud and FedRAMP) to Spinnaker.
...
\Entry
\textbf{Consultant/Subject Matter Expert} - Logical Operations %% \textit{(Part-Time)}
\hfill
%% \DatestampY{2020} - \DatestampY{2022}
\BulletItem
Consulted and created teaching materials for Machine Learning, Artificial Intelligence, and Data Science courses.
...
\BulletItem
3.9 GPA. Coursework: Compiler Optimization, CPU Architecture, LLVM Software Analysis, Applied ML and AI
