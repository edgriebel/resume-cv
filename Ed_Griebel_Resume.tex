...
\Gap
\BulletItem
Led team with cross-functional partners to create REST interfaces to the legacy system, leading to 45\% of emailed payrolls being processed by an AI service agent.
