...
Currently leading an Agile team of SWEs and SDETs to deliver functionality for a large payroll processing system.
\Gap
\BulletItem
...
\BulletItem
Delivered features in a compressed timeframe to recapture \$700,000 annually in payments to terminated workers.
\BulletItem
Improved team productivity by mentoring junior and senior members, onboarding new hires, and focusing on a proactive mindset of empowerment during a period of rapid process and organizational changes.
\end{Detail}

\tech{Python $|$ Java $|$ Oracle SQL $|$ Splunk}
...
\BulletItem
	...
	Reduced on-call load by 80\%, down to a half-day per week, by improving documentation, implementing intake processes, and automating error detection and initial troubleshooting steps.
\BulletItem
...
Researched and implemented plans to address core performance/stability issues; guided culture in satellite office.
